...
<div class="row">
    ...
    <table>
        <tr>
            <td>Code_cat:</td>
            <td><input type="number" name="code_cat"></td>
        </tr>
        <tr>
            <td>Nom_cat:</td>
        ...
        <tr>
            <td></td>
            <td> <input class="btn btn-success" type="submit" value="Ajouter une Categorie"> </td>
        </tr>
    </table> 
    </form>
    <?php
...
<p>
<td>';
                            echo '<a class="btn" href="edit.php?code_cat=' . $row['code_cat'] . '">Read</a>';// un autre td pour le bouton d'edition
                            echo '</td>
<p>
';
                            echo '
...
<td>';
                            echo '<a class="btn btn-success" href="modifierCategories.php?code_cat=' . $row['code_cat'] . '">Update</a>';// un autre td pour le bouton d'update
                            echo '</td>
<p>
';
                            echo'
...
<td>';
                            echo '<a class="btn btn-danger" href="supprimerCategories.php?code_cat=' . $row['code_cat'] . ' ">Delete</a>';// un autre td pour le bouton de suppression
                            echo '</td>
<p>
';
                            echo '</tr>
