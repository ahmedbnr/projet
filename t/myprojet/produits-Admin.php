...
<div class="row">
    ...
    <form method="POST" action="produits-Admin.php">
    <table>
        <tr>
            <td>Ref_Produit:</td>
            <td><input type="number" name="ref_produit"></td>
        </tr>
        <tr>
            <td>Nom:</td>
        ...
        <tr>
            <td>Disponible:</td>
            <td><input type="number" name="disponible"></td>
        </tr>
        <tr>
            <td>Code_cat:</td>
         ...
         <tr>
            <td></td>
            <td> <input class="btn btn-success" type="submit" value="Ajouter un Produit"> </td>
        </tr>
    </table> 
...
<br />
<table id= "resultat" class="table table-hover table-bordered">
