                ...
                <?php
                    ...
                    if($tabSearch)
                    {
                        foreach ($tabSearch as $row)
                        {
                            ...
                            {
                                echo'
                                        <td><a href="Livreur.php?delete=true&id='.$row['id'].'" class="btn btn-danger"> <i class="fa fa-trash"></i></a></td>
                                        <td>
                        ...
                        foreach ($clients as $row)
                        {
                            ...
                            {
                                echo'
                                        <td><a href="Livreur.php?delete=true&id='.$row['id'].'" class="btn btn-danger"> <i class="fa fa-trash"></i></a>
                                            <a class="btn btn-warning" href="modifierEmployer.php?id='.$row['id'].'">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                        </td>
