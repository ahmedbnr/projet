...
if(isset($_POST['submit']))
{
    ...
    if($emailExist == null)
    {
        ...
        if($employer["role"] == 14)
            echo "<script>window.open('Livreur.php','_self')</script>";
        if($employer["role"] == 13)
            echo "<script>window.open('Technicien.php','_self')</script>";
...
<div class="content">
    <div class="container">
        <div class="jumbotron" style="padding: 1rem 2rem">
            <h3 class="text-center" style="font-weight: 600">Modifier Employé</h3>
        </div>
